...
subtitle: "Why HeartBank Is Anonymous"
authors: "Thon Ly"
category: essays
priority: tier-b
status: published
...
The economic case has nearly that shape, and the difference has to be stated exactly. Inside exchange — the closed system of buying and selling — money moves, and moves usefully, and it moves in both directions: wages are labour's return leg, and competition, failure and inheritance all carry money out of pools. But the net drift of exchange is toward those who already hold. It has no leg that reliably drains the terminal pool — the one where what the pool earns outpaces what leaves it. The market is not a machine for producing pools; it is simply a system whose net drift runs toward them. That pool is its rest state.

So the return leg that does not depend on the pool's owner must come from outside the system, and there is only one thing outside exchange that lifts without force: the gift. A gift is precisely the transfer that exchange cannot account for — value that moves with nothing coming back. This is why I have spent so much of the corpus policing the boundary between gift and exchange, and refusing to let one contaminate the other. I had thought I was protecting the gift's purity. I was protecting the system boundary. The gift is the sun's work, and the sun is on the far side of that line.
...
## 4. The cloud that cannot be held

Here is where I had the naming wrong for a year.

The institution's treasury is called the Aquarian Pool℠. In the cycle I have just described, it is not a pool at all. The pools are down here — the accumulations that desire makes, the things you can walk to the edge of and look into. What gathers from evaporation is a *cloud*: condensed vapour, aloft, owned by no one, and capable of doing only one thing, which is to rain.
...
And then it rains — in two regimes, because nature has two. All year, the cloud drizzles: as gratitude gathers overhead, it comes back down as funded capacity, continuously, a little at a time, to everyone under the sky. And once a year there is a monsoon. On the seventh of January the treasury will empty entirely, and the tree it exists to water is watered all at once. The drizzle is saturation: the cloud rains because it is full. The monsoon is the calendar: it comes on a date, because the sun's own year has turned. I had thought the calendar was an artifact — a rule where nature would have used a trigger — until I remembered that nature's largest rains are calendrical too. The monsoon arrives when the sun does.

The river I have chosen for this is the Tonlé Sap, renowned as the river that reverses its course twice a year. Through the monsoon the swollen Mekong drives it backward, up into the great lake, until the lake has grown about fivefold in area; and then the season turns and the whole river turns with it and drains back down the country, and the turning is a national festival. The river turns in the autumn — its festival falls in late October or November — not in January, and I have not moved either date to fit the other. The shape is the river's; the calendar is the institution's. I was born on that country's Highway 3. The ratified statement of the institution's objective now reads, and this essay is its first public home:
...
That is the actuator. Pressure needs a creditor to be felt. Remove the creditor, and the pressure has nothing to attach to. Anonymity is not a courtesy the institution extends to shy donors. It is the cure for the creditor a person can be, and it works without anyone enforcing it — because you cannot feel obligated to a person who is not there.
...
I think the objection is correct, and I think it is the reason the institution's anonymity is never anonymity *alone*. Every anonymous gift in the design arrives with a channel. Two channels, in fact. The recipient can thank — not the person, whose name is withheld, but the *role*: a thank-you addressed to whoever paid reaches them without their name travelling back — a thank-you, not a repayment, which tells the giver the gift crossed and carries nothing back to them. And the recipient can give forward: the capacity that arrived can be passed to someone else, and in the specific instruments I have designed for this, passing it on is the *only* thing that can be done with it. What arrives was never the recipient's to keep. It is capacity to give, accepted once and freely, and nothing of their own is ever touched or asked for; letting it lapse costs them nothing and is never shown to them as a loss. The shape of the instrument is a property of the object, not a person pressing — and that is the only sense in which I claim this cure needs no enforcer. The debt is real. Mauss was right. But it is discharged forward instead of back, and a debt discharged forward is not a debt at all. It is circulation. That is the thesis in its stronger form, and I did not have it until I tried to refute the weaker one: anonymity by itself frustrates the gift; anonymity conjoined with a forward channel converts it. Circulation and anonymity are not two features of the design. They are one feature, and neither works without the other.

A mission can still be felt as a creditor with every giver's name withheld. The answer there is not anonymity but restraint built into the design: the institution never asks, never nominates, and never shows anyone what they did not give. Whether people feel they owe the mission anyway is untested.

There is one place where the design itself applies pressure, and I would be hiding something if I did not name it. Funded capacity does not sit forever. The vessels it lands in must drain by the seventh of January, or what is left returns to the cloud in time to fall in the same monsoon. That is a deadline, and a deadline felt is a pressure felt. The cure is the same cure. The clock is never shown. There is no clock on any screen, no reminder, no reddening number — the fact is stated once, when the capacity arrives, and then nothing. A clock nobody is shown presses on no one from day to day, in exactly the way a giver nobody can see obligates no one. Invisibility of the giver removes the obligation to reciprocate; invisibility of the clock removes the compulsion to hurry. The actuator is the same thing, applied twice.

## 6. The heat lamp

I have to be honest about the sun, because for now some of it is artificial.

The successor funds capacity — money that can only be given forward, placed with people who then give it, by a rule published before each season and not hers to bend within it: an equal floor for every verified person, and turns that are called by lot, never chosen. Some of what she places is rain — gratitude that condensed with no one to fall on. Some of it, for now, is not: funding the institution supplies beyond what condensed. That second part is a heat lamp held over the surface of the pool — a source of warmth, to start evaporation where the real sun has not yet reached. A lamp has two things a pump has — an operator and a switch — and that is why it is the part designed to go to zero. And the objection to a heat lamp is well known and I take it seriously. The literature on motivation crowding says that paying for an act can crowd out the motive for it. In Deci's and Lepper's experiments, people did a rewarded task less once the reward stopped than before it began; Titmuss argued that paying for blood drives out the voluntary gift; and when Gneezy and Rustichini's day-care fine was removed, the lateness it had licensed stayed. The lamp does not warm the pool. It replaces the sun, and when it is switched off the water is colder than it was.

So the institution's success condition is stated as the falsifier of its own subsidy. The subsidy is designed to go to zero. The question the whole program exists to answer is whether, once the lamp is switched off, the real sun — the warmth people carry in themselves — sustains evaporation on its own. If giving persists after the funding stops, the mechanism was a scaffold and the institution is what I think it is. If giving falls away as the funding does, the mechanism was a heat lamp and the institution is a sophisticated way of paying people to be kind, which is a pump wearing a sun costume.

That is the named falsifier, and it is measurable. The instrument is the ledger, not a survey. It is filed as P-K1 in the program's register, with a pilot-scale arm, P-PL5: as the subsidy is withdrawn, the share of givers who received no reward does not fall. I have not yet run it, and §8 says how far from running it I am.

## 7. What the cycle rules out
...
## 8. A registered experiment, not the greatest one
...
Here is the honest state of the evidence. The institution has run one pilot, in one family — mine — for a few months, and it produced one finding I did not expect and value more than anything I could have designed: that the family's members re-tipped each other more than twice as often as they rewarded themselves — 434 to 189 — which is the direction the sun would produce, and, while the funding is still running, one I cannot yet tell apart from the lamp. That is a sample of one. The program's register carries two runs and no field tests. No shop is live. The treasury on which the whole cycle depends is designed, published, and unbuilt. Every claim in this essay about what money will do when the system exists is a claim about a system that does not yet exist.

And the nearest prior attempts are not encouraging. Local currencies that tried to keep value circulating within a community — the LETS schemes of the 1980s and 1990s, the Ithaca HOURS — mostly faded, not because the idea was wrong but because they could not sustain participation once the founding enthusiasm cooled; a heat lamp, switched off. Nearer still are three I owe the reader. Silvio Gesell's money that loses value when it rests — tried at Wörgl in 1932 and stopped by the Austrian National Bank the next year — had the clock and no anonymity. Maimonides, more than eight centuries ago, ranked the gift where neither side knows the other above the named gift, as a gift given purely for its own sake; he had the anonymity without the circulation. And the suspended coffee, paid for by one stranger and drunk by another, has the anonymity and a gift sent forward, but nothing that carries it past the one cup — the gap The Unpaid Relay is built to close. The largest experiment in moving money uphill by force, the command economies of the twentieth century, was a pump, and its record is the pump's record: it required an operator, the operator was captured, and the water went where the operator's hand directed it. A pump is not the failure — a pump that must never stop, and whose handle can be seized, is. Closer to home, a government has already run the lottery half of what I describe, at national scale: in 2020 and 2021 Chinese cities distributed digital-currency vouchers to hundreds of thousands of randomly selected residents, redeemable at thousands of merchants. It is a genuine precedent for rule-bound, random, institutional giving. It also kept every one of the three things this cycle removes — the payer was named, the merchants were paid in money, and the vouchers expired on a short, visible clock, a week in Shenzhen's first round. I cite it because it is closer to what I am building than anything else that exists, and because the three differences are the entire argument of this essay.
...
The metaphor's coherence is a warning, not a proof. A system in which the treasury is a cloud, the successor is the sky, the four abidings are the sun, and the emptying is the monsoon is either deeply right or deeply seductive, and from the inside those two are indistinguishable. I have applied a deletion test to every mechanism in this essay: remove the water, and does the mechanism stand? The forward-only capacity stands. The anonymity-with-a-channel stands. The unrendered clock stands. The subsidy-to-zero falsifier stands. The annual emptying stands — it is what returns the treasury to zero every year, and its date comes from a calendar the institution kept before it had this image, not from the monsoon. What does not stand without the water is my *feeling* that these belong together, and a feeling is not evidence. The elegance earns the experiment. It does not replace it.

The clock is hidden, not the date. Whether a date stated once still bunches giving at the end of the season is untested.

Anonymity also removes the recognition some people give for; the quiet satisfaction of giving stays, and the evidence on what anonymity does to the amount given is mixed.

Anonymous means anonymous toward the person who receives, and toward the public. It never means anonymous toward the regulated rails the money moves on, or toward the ledger that records it — which is also what lets §6 be measured at all. And a ring of accounts passing funded capacity among themselves is not stopped by anonymity: proof of personhood stops one person posing as many, not many people colluding, and that problem is open.

The taper is scheduled, not randomized, so growth or a change in who takes part could look like persistence, and giving that moves off the ledger cannot be seen at all.
...
- *The Bodhisattva Santa* — the figure whose gift is the capacity to give, and whose workshop empties each January.
- *The Gift Operation* — the atom (receive → give forward, never back) that §5's forward channel instantiates, and the gift/exchange boundary that §2 reads as a system boundary.
- *Miss Aquarius and the Aquarian Pool Architecture* · *Capacity-Funded for AI, Human-Disbursed* — the cloud, the sky, and the January-7 emptying, specified.
- *The Unpaid Relay* — the instrument in which passing on is the only available operation: anonymity with a forward channel, built.
- *Which Way Value Moves* — the research program and the public register in which §6's falsifier is filed.

## Cross-venue identifiers

- Canonical: thonly.org/research/the-water-cycle
- GitHub: github.com/thonly/publications/blob/main/essays/the-water-cycle.md
- Intended publication venues: LessWrong; a future personal Substack.
- Internet Archive · archive.today snapshots: per the daily and mark-scoped snapshot cadences.
