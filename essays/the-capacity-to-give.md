---
title: "The Capacity to Give: Why People Come for What They Can Give, Not What They Get"
authors: "Thon Ly"
category: essays
priority: tier-c
status: draft
...
## 1. The question I had backwards
...
## 2. The other half of "giving is a gift too"
...
## 3. The capacity to give, defined
...
## 4. Anonymity to loved ones — the unlock
...
## 5. Three things the ledger showed me
...
## 7. The demand the attention economy cannot meet
...
- *Giving Is a Gift Too* — the supply-side companion this essay completes: redistribution and anonymity let resource-constrained families *afford* to give. This essay's claim is that they *want* to.
- *Emotional Infrastructure as a Public Good* — the felt sense of being held in another's awareness; the capacity to give is its mirror image (holding another in yours).
- *Proof of Humanity* — the verified-human, anonymity-preserving layer that makes anonymous giving to a known loved one possible without fraud.
- *The Bodhisattva Santa* — the figure whose gift is the capacity to give; this essay is the demand-side argument for why that gift is wanted.
- *Two Singularities* and *The Freedom Requirement* — the zero-balance conduit (received gift → license to give onward) of which §5's re-patronage pattern is the lived, voluntary face.

## Cross-venue identifiers

- Canonical: thonly.org/research/the-capacity-to-give
- GitHub: github.com/thonly/publications/blob/main/essays/the-capacity-to-give.md
