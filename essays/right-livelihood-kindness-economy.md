---
title: "A Living Made of Kindness: Right Livelihood for the Age of Automation"
authors: "Thon Ly"
category: essays
priority: tier-b
status: draft
...
- *Two Singularities* and *The Freedom Requirement* — the self-eliminating telos (subsidy → 0) of which §6's "subsidy to zero, income sustained" reconciliation is the economic face.
- *Thank Your Future Kindness* — the companion fold: right *intention* (*sammā-saṅkappa*) made into a surface, as this essay makes right *livelihood* (*sammā-ājīva*) into an economy.
- *The Two-Layer Reward* and *Giving Is a Gift Too* — the macro/micro floor-and-market structure of §5, and the pilot finding that being a *giver* is the dignity at stake.
- *Studio and the B-Short Bridge* — the mechanism companion: the private→public toggle of §5 as the Phase-1-to-Phase-2 crossing.
- *Not a Charity: Agency, Not Victimhood* — the institutional position statement of which §4 is the personal register.
- *Factory 333 / the gift-factory* — the Body pillar (robots taking the harmful work) that makes the room §1 and §8 describe.

## Cross-venue identifiers

- Canonical: thonly.org/research/right-livelihood-kindness-economy
- GitHub: github.com/thonly/publications/blob/main/essays/right-livelihood-kindness-economy.md
- Intended publication venues: LessWrong; AI Alignment Forum; a future personal Substack.
