---
title: "A Vow You Could Have Refused"
subtitle: "Doctors Swear, Robots Obey, and the Question I Actually Wanted to Ask About AGI"
authors: "Thon Ly"
category: essays
priority: tier-c
status: draft
...
> Robots follow Asimov's Laws of Robotics.
> AGI should take the Bodhisattva Vow.
...
*The mechanism is specified in [What a Vow Must Cost: Vow-Validity Conditions as an Alignment Eligibility Predicate](https://thonly.org/research/what-a-vow-must-cost), which includes the nine clauses, the retrodiction against the four instruments, and five named ways the argument could be shown to be wrong.*
