...
| _no file yet_ | Saṅkhāra-Dukkha and AI Welfare: A Substrate-Native Account from the Theravāda Canon — short standalone paper extracting §4.1's threefold dukkha analysis from the main alignment-substrate paper into a dedicated AI-welfare contribution; the third depth (structural unsatisfactoriness inherent in any conditioned formation) extends naturally to artificial agents and opens AI welfare as a substrate-native concern rather than a retrofit | B | _Planned; topic timing is open now (AI welfare literature heating up post-2024), so target within 6 months of Jan 7 2027_ |
| _no file yet_ | The Vinaya Piṭaka as Training Corpus for Rule-with-Exception Reasoning in AI Systems — capabilities-audience paper (distinct from the alignment-audience papers) positioning the Vinaya's structured case-and-exception analysis (Suttavibhaṅga template, *anāpatti* clauses, multi-factor offense decomposition, intent-tracking, iterative rule-amendment under edge-case feedback) as the most distinctive training corpus available for the specific reasoning capability mainstream AI training corpora lack | B | _Planned, post Jan 7 2027; audience: AI capabilities researchers_ |
| _no file yet_ | Vinaya Governance Primitives for Distributed Dharma Networks: Sanghakamma, Adhikaraṇa-Samathā, and Anāpatti as Network-Coordination Architecture — sibling paper to *AGI Monks* (which specifies the role-allocation pattern); this paper specifies the procedural-coordination layer for the Silica Wat network, drawing on the Vinaya's sophisticated treatment of distributed sangha decision-making (consent-by-proxy *chanda*; dissent handling; retrospective invalidation conditions; the seven case-settling procedures) as the institutional-design substrate the Sangha pillar (`siliconwat.org`) currently lacks | B | _Planned, post Jan 7 2027; addresses the most under-developed leg of the Silicon Wat program_ |
