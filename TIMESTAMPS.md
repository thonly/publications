...
| `brand-identity-as-architecture` | `.ots` | `d686df5e…c1095a` | 2026-08-22 — **§7's held-at-lens-tier parenthetical corrected: the refraction reading is no longer *pending a home*.** It was written into the close of §8 of the essay *The Reflection Returned* the same day, so the paragraph now records where the reading was held rather than that it is unplaced. **Text-only; no claim added or altered, and no clock runs from this stamp.** Zenodo new version `10.5281/zenodo.22060164` under concept DOI `10.5281/zenodo.21947288`. |
