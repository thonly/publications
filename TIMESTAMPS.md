...
| `the-sport-that-says-your-name` | `.ots` | `6d0a3660…1f2ed1` | Same-day follow-up — the revision note block updated to record the 07-27 pass and to state that the prior-art clock for claims 17–19 runs from that push rather than from either earlier one. Text-only; no claim changed between `r2` and this. |
