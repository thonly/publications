...
## 1 · The frame that is nearly right, and why nearly is the problem
...
## 2 · What a unicorn valuation actually measures
...
## 3 · The seat invariant

This is the paper's central structure, and it is not an economy measure.

> **`N` counts seats, not salaries.**
> **The sequence is 1 → 1 → 0. It is never 2.**
...
### 4.3 · What the institution actually loses, stated without flinching
...
## 5 · The compliance ceiling, stated against our own interest
...
## 7 · How a no-take-rate institution funds itself
...
> **A name. Exactly one party can hold `@ben`.**
...
## 8 · The analogy that derives the design
...
## 9 · Where the money sits, and why it sits outside
