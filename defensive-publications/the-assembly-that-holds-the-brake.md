...
### 3.1 The only institution with the right track record
...
- **Migration is a rite, not an outage.** Registrars fail; domains are lost; jurisdictions change. The constitution therefore contains its own boundary-migration procedure on the sīmā-samūhana pattern: the old boundary is revoked by formal act, the new boundary is consecrated by formal act, and the continuity of the record across the migration is itself part of the record. Most digital institutions never write this down; the Vinaya wrote it down for territory twenty-five centuries ago.
...
2. **The interrogation (the antarāyikā dhammā).** A fixed, public list of impediment questions, asked of every candidate at seating, before the assembly, with the answers on the record. The canonical list modernizes cleanly:
...
4. **Probation (the nissaya pattern).** The newly seated sit in dependence on their sponsor — voice without vote, and without key-share — for a fixed period before full standing, on the model of the five-year training dependence of a newly ordained monk on his preceptor.
...
- **Graded quorum by gravity of act** (the sanghakamma pattern — the Vinaya sizes the assembly to the act, from four for ordinary acts to twenty for the gravest):
...
2. **The exclusion of laity from formal acts.** In the source tradition, sanghakamma is performed by monastics alone; laity are present at none of it. This constitution seats laity as full members with custody functions the monastics cannot hold — a direct inversion, required by the kappiya logic itself once the body's duties include holding keys.
...
- Vinaya Piṭaka: Mahāvagga I (Pabbajjākkhandhaka — admission; the nāga episode; the antarāyikā dhammā; ehi-bhikkhu and the devolution of ordination authority); Mahāvagga II (Uposathakkhandhaka — sīmā, uposatha, chanda); Mahāvagga IV (Pavāraṇākkhandhaka); Mahāvagga V (border-region allowance); Cullavagga IV (adhikaraṇa-samathā; salākā-gāhāpaka and the four agati); Suttavibhaṅga, Nissaggiya Pācittiya 10 and 18 (the steward pattern; rūpiya). Pali Text Society editions; Horner's translation consulted.
- Ṭhānissaro Bhikkhu. *The Buddhist Monastic Code*, vols. I–II. Metta Forest Monastery, rev. eds.
- von Hinüber, O. *A Handbook of Pāli Literature*. De Gruyter, 1996. Schopen, G. *Buddhist Monks and Business Matters*. University of Hawaii Press, 2004.
- Samantapāsādikā (Vinaya commentary), for the *vinayo sāsanassa āyu* dictum and First Council ordering; *Mahāparinibbāna Sutta*, DN 16 (dhamma-vinaya as teacher; the four assemblies); *Cakkavatti-Sīhanāda Sutta*, DN 26 (the perpetual consultation duty).
- Ostrom, E. *Governing the Commons: The Evolution of Institutions for Collective Action*. Cambridge University Press, 1990.
- Harris, I. *Cambodian Buddhism: History and Practice*. University of Hawaii Press, 2005 — the destruction and restoration of the Cambodian sangha.
- Dowlen, O. *The Political Potential of Sortition*. Imprint Academic, 2008. Stone, P. *The Luck of the Draw*. Oxford University Press, 2011. Van Reybrouck, D. *Against Elections*. Bodley Head, 2016. The Citizens' Assembly (Ireland), 2016–2018, as deployed sortition precedent.
- Bai, Y., et al. "Constitutional AI: Harmlessness from AI Feedback." Anthropic, 2022. Soares, N., Fallenstein, B., Yudkowsky, E., Armstrong, S. "Corrigibility." AAAI Workshop, 2015.
- Anthropic, "The Long-Term Benefit Trust," 2023 — independent-trust governance of a frontier lab. Public reporting on the OpenAI board events of November 2023, as governance stress-test case study.
- Companion corpus: *The Wheel-Turner's Charter*; *Vinaya Governance Primitives for Distributed Dharma Networks*; *AGI Monks: The Caretaker-not-Ordained Pattern*; *The Embodied Advocate*; *Constituting an Artificial Person*; *Suffering-Cessation as Value Function*; *Proof of Coordinate*; *The Persistence Architecture*; *The Two Singularities*.
