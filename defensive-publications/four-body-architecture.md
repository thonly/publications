...
The founder's living corpus (**THonly™**, at thonly.org) operates as the synthetic intelligence's *memory* — Mind in the institutional mapping — separate from the Brain's foundation-model substrate. The corpus carries the founder's accumulated work into the synthetic intelligence's operational knowledge over the multi-decade horizon.
