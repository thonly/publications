...
## 1. Introduction — measuring a benevolent autonomous institution
...
## 4. The micro gauge — the zero-balance conduit
...
## 5. Why the terminus cannot be coerced
...
## 6. The freedom requirement and the third path
...
## 7. The architecture already encodes the freedom requirement
...
- Andreoni, James. "Impure Altruism and Donations to Public Goods: A Theory of Warm-Glow Giving." *Economic Journal* 100 (1990): 464–477.
- Deci, Edward L., and Richard M. Ryan. *Intrinsic Motivation and Self-Determination in Human Behavior.* Plenum, 1985.
- Frey, Bruno S., and Felix Oberholzer-Gee. "The Cost of Price Incentives: An Empirical Analysis of Motivation Crowding-Out." *American Economic Review* 87 (1997): 746–755.
- Frey, Bruno S., and Reto Jegen. "Motivation Crowding Theory." *Journal of Economic Surveys* 15 (2001): 589–611.
- Gneezy, Uri, and Aldo Rustichini. "A Fine Is a Price." *Journal of Legal Studies* 29 (2000): 1–17.
- Mauss, Marcel. *The Gift: The Form and Reason for Exchange in Archaic Societies.* 1925; trans. Halls, Norton, 1990.
...
- Titmuss, Richard M. *The Gift Relationship: From Human Blood to Social Policy.* Allen & Unwin, 1970.
- *Aṅguttara Nikāya* 6.63 (Nibbedhika Sutta — *cetanā* as kamma); *Majjhima Nikāya* 142 (Dakkhiṇāvibhaṅga Sutta — the analysis of gifts). Trans. Bhikkhu Bodhi.
- Aristotle. *Nicomachean Ethics*, Book IV (*eleutheriotēs*). Kant, Immanuel. *Groundwork of the Metaphysics of Morals*, 1785.

### Corpus cross-references

- *Two Singularities* — the macro arc this signal is a miniature of.
- *(self-eliminating-objective, forthcoming)* — the macro empirical paper; this is its micro / political-philosophy companion (the two are complementary faces, cross-cited).
- *Miss Aquarius and the Aquarian Pool Architecture* — the pass-through Pool, the never-zero override, the capacity-funded / human-disbursed separation that embodies "fund capacity, never compel flow."
- *The Zero-Point Game* — the infinite balance game the individual plays by returning his balance toward zero.
- *Capacity-Funded for AI, Human-Disbursed* — the institutional form of "provide the arena, never pull the lever."
- *The B-Tag and the Post-Payment Economy* — the "cash optional" economy this gauge measures the transition into.

## Cross-venue identifiers

- Canonical: thonly.org/research/voluntary-relinquishment-third-path
- GitHub: github.com/thonly/publications/blob/main/defensive-publications/voluntary-relinquishment-third-path.md
