...
- **Prosocial spending raises happiness.** Dunn, Aknin, and Norton (*Science*, 2008) found that spending money on others produces greater happiness than spending it on oneself, and that this holds when assigned experimentally, not merely correlationally.
- **It generalizes across cultures and income levels.** Aknin and colleagues found the prosocial-spending–wellbeing link across a large majority of countries, rich and poor — including in contexts of real material scarcity, where one might expect self-spending to dominate.
- **It appears before it could be taught.** Toddlers show greater happiness giving treats away than receiving them, and greater happiness still when the giving is costly to them — suggesting the giver's reward is closer to a human universal than to a learned, surplus-dependent luxury.
...
The contemplative traditions said the same long before the journals. In Buddhism, **dāna** (giving) is the first of the perfections, and the teaching is explicit that the act dignifies and benefits the **giver** — the merit, the softening of grasping, the joy — as much as the recipient. **Muditā**, sympathetic joy, names the gladness one feels at another's good, which the giver tastes directly.

The finding, then, is robust and old: **to give is to receive a particular happiness available no other way.** The question this paper presses is the one the finding leaves unasked.

---

## 3. The hidden precondition

Every study of prosocial spending presupposes something it does not measure: **that the giver has money to spend prosocially.** The experiments hand participants a sum and ask them to give some away. Real life hands no such sum. To give freely, one must first have a surplus — income beyond what subsistence and obligation already claim.

For a large fraction of humanity, that surplus does not exist. When earning enough to feed, house, and school a family is itself the entire daily struggle, there is no remainder to give from. The wellbeing dividend of giving — real, repeatable, cross-cultural — sits behind a gate the poor cannot pass: **you may have the happiness of giving once you can afford to give.**
...
This is not a moral failing of the poor — they are, famously and repeatedly, *more* generous as a share of what they have. It is a structural exclusion: the **occasion** and **means** to give freely are what scarcity removes, not the will.

---

## 4. Giving is means-tested by the market

Put plainly: in a pure market arrangement, **the happiness of giving is means-tested.** Those with surplus can buy it (by giving away the surplus and reaping the warm glow, the meaning, the social bond); those without surplus cannot. One of the most reliable non-material sources of flourishing is, in effect, **sold only to those who already have enough** — and withheld, silently, from those who have least.

This compounds material inequality with a subtler **flourishing inequality**. The poor are excluded twice: once from comfort, and again from the dignity and joy of being a benefactor. Charity, as conventionally arranged, *deepens* the second exclusion — it casts the poor permanently as recipients, the objects of others' giving, never its subjects.
...
The consequence is decisive: **every participant is always-already a giver.** Giving no longer requires a pre-existing surplus, because a portion of what one receives arrives *pre-designated for giving*. The system does not ask the poor to find a surplus they do not have; it routes a giving-portion to them as part of the gift, so that being-a-giver is built into being-a-participant.
...
The net effect: anonymity makes generosity **culturally safe** (no shame in giving little, no shame in receiving), **socially rewarding** (the warm glow and bonding without the status games), and **financially accessible** (the giving-portion is provided structurally). These three together are what scarcity normally denies.

---

## 7. Recursive diffusion

The 50/50 circulation has a notable mathematical-social shape. Each re-tip can itself trigger a re-tip (the recipient now holds a giving-portion), and so on. The *amount* at each hop is bounded by the recursive halving — a geometric series whose total is finite (a quantity T, fully re-tipped down its chain, transfers at most T onward in aggregate; the system is **redistributive, not inflationary**). But the *social* quantity moves the opposite way: each hop touches a new person with the experience of both receiving and giving, so **appreciation spreads outward as the amount shrinks toward zero.**
...
- **Dunn, Aknin & Norton (2008); Aknin et al. (cross-national)** — prosocial spending raises wellbeing, experimentally and across cultures and income levels.
- **Andreoni (1990), "warm-glow giving"** — the giver's own satisfaction as a real, separable good.
- **Aristotle** — *eleutheriotēs* (liberality) and *megaloprepeia* (magnificence): giving well is a virtue and an excellence of character, not a surplus disposal problem.
- **Marcel Mauss, *The Gift* (1925)** — the gift as the binding institution of social life; reciprocity as the weave of community.
- **Richard Titmuss, *The Gift Relationship* (1970)** — the social and moral superiority of gift-based systems (voluntary blood donation) over market ones; giving as a public good.
- **Amartya Sen, capability approach** — the *capability to give* as a functioning people have reason to value; poverty as capability deprivation, here extended to the capability to be generous.
- **Self-Determination Theory (Ryan & Deci)** — relatedness and autonomy as basic needs; autonomous, non-coerced giving satisfies both.
- **E. F. Schumacher, *Buddhist Economics*** — economic arrangements judged by whether they ennoble; an economics in which giving is structurally available is a Buddhist-economic design.
- **Viktor Frankl** — meaning through contribution; the giver finds meaning the recipient-only role withholds.
...
- **Founder-funded rewards.** The giving-portions were seeded by the founder; un-subsidized dynamics are untested.
...
1. The **framing** that the giving-and-wellbeing dividend is *means-tested by the market* — withheld from those without surplus — and that this is a distinct, addressable inequity.
2. The **mechanism thesis** that earmarked-circulation (the giving-portion arrives as part of the gift) + anonymity (neutralizing the small-gift and large-gift failure modes) can **restore the experience of giving to the resource-constrained**, making generosity culturally safe, socially rewarding, and financially accessible.
3. The **dignity reframing** of acknowledgment infrastructure from *being seen* to *being one who gives*, with connection as the relational byproduct.
4. The **give-side virality** observation: the wish to give as a distribution force (amount → 0, appreciation → outward).
...
- Pilot field record (internal) — the first-month observation that prompted this thesis.
