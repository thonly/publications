...
- **It generalizes across cultures and income levels.** Aknin and colleagues (2013) found the prosocial-spending–wellbeing link across 136 countries, rich and poor — including in contexts of real material scarcity, where one might expect self-spending to dominate.
...
- **Dunn, Aknin & Norton (2008); Aknin et al. (2013, 136 countries); Aknin, Hamlin & Dunn (2012, toddlers)** — prosocial spending raises wellbeing, experimentally and across cultures and income levels.
...
- **E. F. Schumacher, *Buddhist Economics* (1966; collected 1973)** — economic arrangements judged by whether they ennoble; an economics in which giving is structurally available is a Buddhist-economic design.
- **Viktor Frankl** — meaning through contribution; the giver finds meaning the recipient-only role withholds.
- ***Charity and Shame* (Social Problems 69(2), 2022)** — from the recipients' side, reciprocity restores worth: *to be able to give, and not just receive*. The closest anticipation of §8's reframing, and it precedes this paper.
...
- **PayForward, US 2015/0332306 A1 (priority 2014)** — merchant rebates allocated by the user to designated beneficiaries and causes: a giving-portion that arrives as part of a transaction. It anticipates the earmark and cuts against claim 2 as a bare idea; what it lacks is the recursion, the default anonymity and the family scope.
...
- **Untested unsubsidised.** The thesis is falsified if re-tipping ceases when the seed is withdrawn and the jar comes to be treated as routing rather than felt giving; the register's pilot-scale inelasticity prediction (P-PL5, gated on the Q2 2027 taper) is the instrument that will read it.
