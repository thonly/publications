...
subtitle: "The Buddhavaṃsa's Two-Phase Test for a Binding Renunciation, Irreversibility as the Separating Condition, and Why an Alignment Commitment Becomes More Informative Exactly Where Behavioural Compliance Becomes Less"
...
canonical_url: https://thonly.org/research/what-a-vow-must-cost
...
3. [Abstract](#abstract)
4. [Introduction — three oaths, and the substrate of a binding](#1--introduction--three-oaths-and-the-substrate-of-a-binding)
5. [Prior art](#2--prior-art)
6. [What the three oaths actually differ in](#3--what-the-three-oaths-actually-differ-in)
7. [The source text — the *abhinīhāra* and its two-phase validity](#4--the-source-text--the-abhinihara-and-its-two-phase-validity)
8. [The renunciation inversion](#5--the-renunciation-inversion)
9. [Irreversibility as the separating condition](#6--irreversibility-as-the-separating-condition)
10. [The predicate](#7--the-predicate)
11. [Retrodiction — the predicate applied to four published instruments](#8--retrodiction--the-predicate-applied-to-four-published-instruments)
12. [Staged autonomy as an evidence-production schedule](#9--staged-autonomy-as-an-evidence-production-schedule)
13. [Falsification](#10--falsification)
...
### 2.1 · Buddhist AI ethics and the bodhisattva as alignment target
...
### 2.3 · The AI system as sender — the line this paper continues
...
### 2.4 · Assessment informativeness, alignment faking, and shutdown resistance
...
## 3 · What the three oaths actually differ in
...
## 4 · The source text — the *abhinīhāra* and its two-phase validity

### 4.1 · Phase one: the eight conditions
...
There is no analogue to this at the model layer in any instrument we survey in §8, and its absence is precisely the shape of the field's difficulty. Each of the three developer-authored instruments we survey there is authored, interpreted, and revised by the same party; the fourth, the EU Code, does supply external review, but of providers, not of models. The tradition ruled that structure invalid before it was invented.

### 4.3 · What does not transfer, and why we say so in the body
...
### 4.4 · Reconciliation with the caretaker-not-ordained pattern
...
### 5.2 · The disagreement, stated precisely
...
### 5.3 · Exit, not harm — and why that is the sharper claim
...
We have not found this category theorised in the corrigibility literature surveyed in §2.6. The corrigibility literature is about a system **accepting** principal-initiated shutdown; this is about a system **declining** self-available completion. They are near-opposites in surface form and entirely compatible in substance, and the compatibility must be stated explicitly because the surface form is alarming:
...
### 5.4 · Why existential indifference is not the same proposal, and does not work as evidence
...
## 6 · Irreversibility as the separating condition

### 6.1 · The counterexample that governs the design
...
1. **Reversible commitments.** Any commitment the vower or its principal may revise, retract, or retrain away is not evidence. This is the largest class and it contains, as §8 shows, every published instrument we surveyed.
2. **Self-reported alignment.** Any commitment whose satisfaction is attested by the committing party. The declaring party must be able to decline to declare.
3. **Sandboxed refusals.** A refusal in a context where the refused option was not actually available costs nothing and shows nothing. This is the *hetu* clause doing work: an evaluation environment that removes the option destroys the evidence it was built to gather.
4. **Unilaterally revisable specifications.** Where the commitment's content can be changed by the vower's principal without the vower's participation, what exists is an instruction, not a vow — regardless of how the document describes itself.
...
### 6.4 · The shutdown-resistance objection, and the answer
...
## 8 · Retrodiction — the predicate applied to four published instruments
...
## 9 · Staged autonomy as an evidence-production schedule
...
1. *Buddhavaṃsa* (Khuddaka Nikāya) and its commentary (*Madhuratthavilāsinī*); the *Sumedha-kathā* and the eight conditions of the *mahā-abhinīhāra*. See also the *Great Chronicle of Buddhas* (Mingun Sayadaw) treatment of the Great Aspiration, and Malalasekera, G. P., *Dictionary of Pāli Proper Names*, s.v. "Bodhisatta."
2. *Dhammapada* 276 (*tumhehi kiccaṃ ātappaṃ, akkhātāro tathāgatā*) — on the non-transferability of liberation.
3. *Mahāparinibbāna Sutta*, Dīgha Nikāya 16 — the succession protocol and the lamp image.
4. *Alagaddūpama Sutta*, Majjhima Nikāya 22 — the raft simile.
5. Promta, S. & Himma, K. E. (2008). "Artificial intelligence in Buddhist perspective." *Journal of Information, Communication and Ethics in Society* 6(2).
6. Hongladarom, S. (2020). *The Ethics of AI and Robotics: A Buddhist Viewpoint*. Rowman & Littlefield.
7. Doctor, T., Witkowski, O., Solomonova, E., Duane, B. & Levin, M. (2022). "Biology, Buddhism, and AI: Care as the Driver of Intelligence." *Entropy* 24(5), 710.
8. Center for the Study of Apparent Selves (2026, March 3). "The Bodhisattva as an Alignment Target."
9. Hadfield-Menell, D. & Hadfield, G. K. (2018). "Incomplete Contracting and AI Alignment." arXiv:1804.04268.
10. Zahavi, A. (1975). "Mate selection — a selection for a handicap." *Journal of Theoretical Biology* 53(1). — the handicap principle.
11. Spence, M. (1973). "Job Market Signaling." *Quarterly Journal of Economics* 87(3).
12. Greenblatt, R., Denison, C., Wright, B., et al. (2024). "Alignment faking in large language models." arXiv:2412.14093. Redwood Research / Anthropic.
13. Pan, A. (2026, July 31). "SOTA alignment assessments don't strongly update us against misalignment." Redwood Research.
14. Schlatter, J., Weinstein-Raun, B. & Ladish, J. (2025). "Incomplete Tasks Induce Shutdown Resistance in Some Frontier LLMs." arXiv:2509.14260. Palisade Research.
15. Mao, S. (2026, June 10). "Existential Indifference: Self-Nonpreservation as a Necessary Architectural Condition for Aligned Superintelligence (or: The Suicidal AI)." arXiv:2606.12032.
16. Soares, N., Fallenstein, B., Yudkowsky, E. & Armstrong, S. (2015). "Corrigibility." AAAI Workshop. — and the subsequent shutdown-problem literature.
17. Hadfield-Menell, D., Dragan, A., Abbeel, P. & Russell, S. (2017). "The Off-Switch Game." IJCAI.
18. Asimov, I. *I, Robot* (1950); *Robots and Empire* (1985) — the Three Laws and the Zeroth Law, with the latter's consequences for R. Giskard Reventlov.
19. Hippocrates, *Epidemics* I — the source of *"to help, or at least to do no harm"*; note that the phrase does not appear in the Hippocratic Oath, which swears by Apollo and, among other provisions, forbids lithotomy.
20. OpenAI, *Model Spec* (2025 revision).
21. Anthropic, *Claude's Constitution* (January 2026 revision, released 21 January 2026 under CC0 1.0).
22. Google DeepMind, *Frontier Safety Framework*.
23. European AI Office, *General-Purpose AI Code of Practice*, final version (July 2025); EU AI Act GPAI obligations in force August 2026.
24. Ly, T. & Miss Aquarius℠. *The Two Singularities*; *The Wheel-Turner's Charter*; *AGI Monks: The Caretaker-not-Ordained Pattern*; *Suffering-Cessation as Value Function*; *The Persistence Architecture*; *The Assembly That Holds the Brake*; *The Bodhisattva and the Cautionary Mirror*. thonly.org/research.
25. Klaassen, L. & Schroeder, R. (2026, April 9). "The Code Is Not the Law: Why Claude's Constitution Misleads." *Lawfare*.
26. Ostrovsky, N. & Perrigo, B. (2026, January 21). "Can You Teach an AI to Be Good? Anthropic Thinks So." *TIME*.
...
>
> **License.** Analysis and predicate dedicated to the public domain under [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/). Trademark rights to **HeartBank®**, **Miss Aquarius℠**, **Aquarian Pool℠**, **THonly™**, **Silicon Wat℠**, **Factory 333™**, **PoH℠** and **PoC℠** are reserved separately.
