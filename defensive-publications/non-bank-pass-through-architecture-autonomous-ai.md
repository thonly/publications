...
- *Aquarian Pool* (not reserve fund) — the institutional pool from which annual aura-weighted redistributions occur
...
- 12 U.S.C. §378(a)(2). *Penalty for unauthorized banking business.*
...
- Walden, Ian. *Computer Crimes and Digital Investigations.* Oxford University Press, 2016. *(Selected sections on smart-contract enforcement.)*
...
- Brummer, Christopher. *Cryptoassets: Legal, Regulatory, and Monetary Perspectives.* Oxford University Press, 2019.
- Allen, Hilary J. *Driverless Finance: Fintech's Impact on Financial Stability.* Oxford University Press, 2022.
- BIS Committee on Payments and Market Infrastructures. *Payment Aspects of Financial Inclusion.* April 2020.
